...
const Card = () => {
  return (
    <div className="z-10">
      <div className="sm:min-w-[260px] h-fit rounded-lg mx-5 px-5 py-2 hover:cursor-pointer hover:shadow-2xl">
        ...
        <div className="h-44 w-full my-2">
          <div className="h-full w-full group relative overflow-hidden">
            <img
              ...
              src="https://eu.muroexe.com/66352-large_default/custom.jpg"
              alt=""
            />
            <img
              className="absolute top-0 h-full w-full object-cover transition-all opacity-0 group-hover:opacity-100"
              src="https://eu.muroexe.com/img/roundview/1793/a_0_0_853_0_0.jpg"
              alt=""
            />
          </div>
        </div>
          ...
          <ul className="flex justify-center flex-wrap w-full">
            <li>
              <img
                ...
                src="https://eu.muroexe.com/66320-home_default/dusk.jpg"
                alt=""
              />
            </li>
            <li>
        ...
        <div className="flex justify-between items-center">
          <div className="text-lg font-bold">
            <p className="text-[#c20000]">NAME</p>
            <p>1000VNĐ</p>
          </div>
